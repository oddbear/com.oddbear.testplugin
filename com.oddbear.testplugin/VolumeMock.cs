...
namespace com.oddbear.testplugin
{
    internal class VolumeMock : INotifyPropertyChanged
    {
        ...
        private int _headphonesVolume;
        public int HeadphonesVolume
        {
            get
            {
                var cachedValue = _memoryCache.Get(nameof(HeadphonesVolume)) as int?;
                return cachedValue ?? _headphonesVolume;
            }
            set
            {
